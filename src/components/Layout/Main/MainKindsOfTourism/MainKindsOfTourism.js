        ...
        <div className="main-tourism-block">
            <Spin spinning={loading} size={"large"}>
                <div className="text-over-picture">
                    <img src={tourism1} className="pictures" alt={'Рекреационный туризм'}/>
                ...
                <div className="text-over-picture">
                    <img src={tourism2} className="pictures" alt={'Оздоровительный туризм'}/>
                    <div className="appeared-text">
                        ...
                        оздоровлении организма после перенесенных заболеваний. Здесь можно говорить о турах с
                        исключительно
                        лечебной целью, для лечения каких-либо тяжелых заболеваний, реабилитации после травм, аварий,
                        операций и турах лечебно-оздоровительных, с целью поддержания молодости, красоты и здоровья,
                        снятия
                        стресса и усталости.
                    </div>
                ...
                <div className="text-over-picture">
                    <img src={tourism3} className="pictures" alt={'Познавательный туризм'}/>
                    <div className="appeared-text">
                        ...
                        достопримечательностями, музеями, театрами, традициями народов в посещаемой стране. Поездка
                        может
                        включать в себя и познавательные и рекреационные цели одновременно.
                    </div>
                </div>
                <div className="text-over-picture">
                    <img src={tourism4} className="pictures" alt={'Деловой туризм'}/>
                    <div className="appeared-text">
                        ...
                        выставках, салонах, а также для проведения переговоров и заключения контрактов, монтажа и
                        наладки
                        оборудования.
                    </div>
                </div>
                <div className="text-over-picture">
                    <img src={tourism5} className="pictures" alt={'Спортивный туризм'}/>
                    <div className="appeared-text">
                ...
                <div className="text-over-picture">
                    <img src={tourism6} className="pictures" alt={'Этнический туризм'} />
                    <div className="appeared-text">
                ...
                <div className="text-over-picture">
                    <img src={tourism7} className="pictures" alt={'Религиозный туризм'}/>
                    <div className="appeared-text">
                        ...
                        разновидности: паломнический туризм (отдельно следует выделить духовно-паломническое
                        направление) и
                ...
                <div className="text-over-picture">
                    <img src={tourism8} className="pictures" alt={'Образовательный туризм'}/>
                    <div className="appeared-text">
                        ...
                        повышения квалификации либо углубления знаний по тем или иным дисциплинам. Наиболее популярными
                        в
